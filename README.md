...
## 🤖 Optional: Connect Gemini AI (Recommended)

The tool works great without any AI setup — but connecting Google Gemini makes it significantly more powerful:

| Without Gemini | With Gemini |
|---|---|
| Built-in keyword scanner | AI reads the JD like a recruiter |
| May produce occasional garbage tags | Clean, accurate extraction every time |
| No boolean refinement | Gemini reviews & improves your search string |
| Manual report writing | AI writes the report narrative automatically |

**Gemini is free.** Google provides a free API key that allows hundreds of uses per day — no credit card needed.

### How to get your free Gemini API key (5 minutes)

**Step 1 — Open Google AI Studio**

Go to **[aistudio.google.com](https://aistudio.google.com)** in your browser and sign in with your Google or Workspace account.

> 💡 Use the same Google account you use at work (e.g. your `@dynatrace.com` account).
...
3. A key will be generated — it looks like this: `AIzaSyXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX`
4. Click **Copy** to copy it

> ⚠️ Keep this key private — don't share it in emails or documents. It's your personal key.

---

**Step 3 — Add the key to Talent Pool Scout**

1. Open the tool: **[Talent Pool Scout](https://nitin-gr-dyntrace.github.io/Talent-pool/talent_pool_scout.html)**
2. Click the **⚙️ Connect Gemini** button in the top-right corner
3. Paste your key into the field that says *"Paste your key here (AIza…)"*
4. Click **Save**
5. The button will change to **🟢 Gemini Connected** — you're done!

> ✅ Your key is saved in your browser only. You only need to do this once per device. It is never shared with anyone.

---

**What changes after connecting**

- The **🪄 Scan & Fill Form** button now uses Gemini instead of the keyword scanner — results are much cleaner and more accurate
- After generating a boolean string, a new **✨ Refine with Gemini** button appears — click it to get AI feedback and alternative search variations
- The hiring manager report is written automatically by AI
...
No logins. No installs. Works in any browser. Optional free Gemini API key unlocks AI-powered parsing and report writing.
